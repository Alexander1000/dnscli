...
// zoneDelCmd represents the del command
var zoneDelCmd = &cobra.Command{
	Aliases: []string{"rm"},
	Use:     "del",
	Short:   "Delete zone from authoritative servers",
	Example: "  dnscli zone del --name example.com",
	Run:     zoneDelCmdRun,
}
...
func zoneDelCmdRun(cmd *cobra.Command, args []string) {
	a, err := app.New(
